...
const styles = {
  ...
  main: { padding: "22px 24px 120px", display: "flex", flexDirection: "column", gap: 16 },
  ...
  footer: { position: "fixed", left: 0, right: 0, bottom: 0, maxWidth: 980, margin: "0 auto", background: "rgba(255,255,255,0.95)", backdropFilter: "blur(8px)", borderTop: `1px solid ${T.line}`, padding: "10px 16px", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "flex-end", gap: 10 },
