...
const styles = {
  ...
  // Tabla compacta: baja minWidth y aprieta padding/fuente para que en móvil se
  // vean más columnas y más renglones sin scroll horizontal (guardando proporción).
  table: { width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 452 },
  th: { background: T.pine, color: '#fff', fontSize: 9.5, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 0.3, padding: '6px 5px', textAlign: 'right' },
  thLeft: { textAlign: 'left', paddingLeft: 9 },
  thEq: { background: T.amber, color: '#211C17', fontSize: 9.5, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 0.3, padding: '6px 4px', textAlign: 'center', width: 50 },
  thU: { display: 'block', fontSize: 8.5, fontWeight: 500, opacity: 0.8, letterSpacing: 0 },
  tdLeft: { padding: '6px 5px 6px 9px', textAlign: 'left', borderBottom: `1px solid ${T.lineSoft}`, color: T.ink, fontWeight: 500, fontSize: 11.5, lineHeight: 1.25 },
  td: { padding: '6px 5px', textAlign: 'right', borderBottom: `1px solid ${T.lineSoft}`, color: T.inkSoft, fontVariantNumeric: 'tabular-nums' },
  tdEq: { padding: '4px 3px', textAlign: 'center', borderBottom: `1px solid ${T.lineSoft}`, background: '#FBF6EF' },
  eqInput: { width: 40, textAlign: 'center', border: `1px solid ${T.line}`, borderRadius: 6, padding: '5px 2px', fontSize: 12.5, fontWeight: 700, color: T.pine, background: '#fff', fontFamily: mono, boxSizing: 'border-box' },
  trOn: { background: '#FFFDFA' },
  trTot: { background: T.mint },
  tdTotLabel: { padding: '8px 5px 8px 9px', fontWeight: 800, color: T.pine, textTransform: 'uppercase', fontSize: 10.5, letterSpacing: 0.3 },
  tdTot: { padding: '8px 5px', textAlign: 'right', fontWeight: 800, color: T.pine, fontSize: 12.5, fontVariantNumeric: 'tabular-nums' },
  trAd: { background: '#FFFFFF' },
  trDist: { background: '#FBF8F4' },
  tdAdLabel: { padding: '6px 5px 6px 9px', fontWeight: 600, color: T.inkSoft, fontSize: 10.5 },
  tdAd: { padding: '6px 5px', textAlign: 'right', fontWeight: 800, fontSize: 11.5, fontVariantNumeric: 'tabular-nums' },
  tdDist: { padding: '6px 5px', textAlign: 'right', fontWeight: 700, color: T.ink, fontSize: 11.5, fontVariantNumeric: 'tabular-nums' },
