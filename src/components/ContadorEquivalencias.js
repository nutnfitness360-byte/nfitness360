...
const S = {
  ...
  gline: { display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderTop: '1px solid var(--soft, var(--line-soft))' },
  ...
  gname: { flex: 1, fontSize: 13, fontWeight: 600, color: 'var(--ink, var(--ink))', cursor: 'pointer' },
  ...
  stepVal: { minWidth: 46, textAlign: 'center', fontSize: 13, fontWeight: 800, color: 'var(--dark)', borderLeft: '1px solid var(--soft, var(--line-soft))', borderRight: '1px solid var(--soft, var(--line-soft))', padding: '0 2px', lineHeight: '30px' },
  ...
  grpName: { fontSize: 12.5, fontWeight: 600, color: 'var(--ink, var(--ink))' },
