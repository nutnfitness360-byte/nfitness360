...
function _ceqG(g,eq){ var N=function(i){ return num(eq && eq[i]); };
  ...
  if (g==='lacteo') return N(9)+N(10)+N(11)+N(12); return 0; }
var _CLBL={cereal:'Cereal',proteina:'Proteína',grasa:'Grasa',verdura:'Verdura',fruta:'Fruta',lacteo:'Lácteo',libres:'Libres'};
...
function prepConGramajes(nombre, eq, recetaOriginal){
  try {
    ...
    var out = [], orden = ['cereal','proteina','verdura','fruta','grasa','lacteo','libres'];
