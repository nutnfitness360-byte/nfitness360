  ...
  return (
    <div style={{background:'var(--dark)',minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',padding:'2rem'}}>
      <div style={{width:'100%',maxWidth:'340px',textAlign:'center'}}>
        ...
        <div style={{fontFamily:'var(--font)',fontSize:'10px',fontWeight:'600',color:'var(--stone)',letterSpacing:'8px',textTransform:'uppercase',marginTop:'6px',marginBottom:'2.5rem'}}>Fitness 360</div>
