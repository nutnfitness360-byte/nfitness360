  ...
  return (
    <div className="app">
      <div className="topbar">
        ...
        <div className="avatar" onClick={() => signOut(auth)} title="Cerrar sesión">
      ...
      <div className="content">
              ...
              {proxima ? (
                <>
                  <div style={{fontSize:'12px',color:'var(--stone)',marginBottom:'1rem'}}>
                    Tu próxima cita es el <strong style={{color:'var(--dark)'}}>{fmtFecha(proxima.fecha)}</strong> a las <strong style={{color:'var(--dark)'}}>{proxima.hora}</strong>
                  </div>
        ...
        {tab === 'agendar' && <Agenda isNutri={false} />}
        ...
        {tab === 'planes' && (
          <div className="card">
            ...
            <div className="empty-state">
              ...
              Tu nutrióloga asignará tu plan aquí cuando esté listo
            </div>
          </div>
        )}
      </div>
